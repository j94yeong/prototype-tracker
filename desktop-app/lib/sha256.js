/*
 * CommonJS adapter for the shared sha256 implementation.
 *
 * Reuses /lib/sha256.js from the repo root (which now also exports via
 * `module.exports` when loaded under Node/CommonJS) instead of duplicating
 * the algorithm here. This guarantees byte-for-byte identical hashing
 * between the desktop app and the existing file:// harness / viewer.html.
 *
...
module.exports = require(resolveSharedLibPath('sha256.js'));
